...
Building on Sean's synthesis (at bottom of this version), I've synthesized even further. I have divided the set into topical sections aligned with http://explore.dublincore.net/sub-vocabulary-v2/. Each competency begins with my edit denoted "Synthesis" followed immediately by the section content from Sean's work (denoted "Original"). In editing, I've started each competency and benchmark with the key action verb. I've used "Using" a lot deliberately assuming we'd further wordsmith those verbs. 
======================================================================
...
--------ORIGINAL--------
COMPETENCY:
Knows about subject-predicate-object structure
...
--------ORIGINAL--------
COMPETENCY:
Is able to retrieve and access RDF data from the "open Web".
...
--------ORIGINAL--------
COMPETENCY:
Uses relevant resources to discover existing Linked Data datasets. Example: Datahub, which uses CKAN and links to the Linked Open Data Cloud.
...
--------ORIGINAL--------
COMPETENCY:
Is able to formulate advanced queries on data with blank nodes
...
--------ORIGINAL--------
COMPETENCY:
Knows about full structure of queries (PREFIX, SELECT, FROM, WHERE, ORDER BY, LIMIT, OFFSET)
...
--------ORIGINAL--------
COMPETENCY:
--Understands use of SPARQL functions and operators ---STUART
...
--------ORIGINAL--------
COMPETENCY:
Knows about the named graph concept
...
--------ORIGINAL--------
COMPETENCY:
Understands the difference between a Default Graph and a Named Graph, and the use of the GRAPH clause in queries
...
--------ORIGINAL--------
COMPETENCY:
Is able to formulate advanced queries using subqueries
...
--------ORIGINAL--------
COMPETENCY:
Understands SPARQL over HTTP, the use of GET and POST, and that graphs given in the protocol override graphs given in the query.
...
--------ORIGINAL--------
COMPETENCY:
Is able to use a temporary variable to extend a query
...
--------ORIGINAL--------
COMPETENCY:
Understands the role of Property Paths and how to form them by combining predicates with regular expression-like operators.
...
--------ORIGINAL--------
COMPETENCY:
If necessary, is able to convert/manipulate SPARQL query outputs (RDF-XML, JSON) to the exact format required by a third party tool/API
...
--------ORIGINAL--------
COMPETENCY:
Is able to formulate queries using FROM with URLs and local files
...
--------ORIGINAL--------
COMPETENCY:
Is able to read and understand a high level description of classes and properties of the dataset provided by a website/ endpoint in order to write a query.
...
--Is able to access dbpedia’s snorql/sparql endpoint and issue simple queries
...
--------ORIGINAL--------
COMPETENCY:
Is able to take large datasets and distill results so that visualizations are human-friendly and relationships are comprehendible
=========================================================
...
--------ORIGINAL--------
COMPETENCY:
Uses W3C Guidelines for Collecting Metadata on Linked Datasets when registering datasets with relevant services: Datahub/Linked Open Data Cloud
...
--------ORIGINAL--------
COMPETENCY:
If available, uses an Ontology browsing interface to explore the ontologies used in a particular dataset.

=========================================================



>> START SEAN'S 0/22 CONTRIBUTION 
