...
*  RDF data model 
  ...
  * __Understands that "real-world" things may be named using URIs separate from the URIs used 
    to denote information about those things.__
...
*  Programming RDF Data
  ...
  * __Sean: see Proposal #7 - see also "Web technology" or "LD Application architecture"__
*  Querying RDF Data
...
__3. Sean proposes, for "Designing RDF-based vocabularies":
...
__4. Sean proposes, under "Managing identifiers":
  ...
  * Understands the principle of persistence, i.e. that a URI is permanently
    ...
    * [Tom comments: Perhaps too much detail here?  See proposal below.]
  * Understands the principle of dereferencability, i.e. a user agent can make
    ...
    * Ensures that If the user agent is an RDF client then RDF is returned from
      the same URI.
    * [Tom comments: There is already a point about content negotiation under "publishing 
      RDF vocabularies"]
...
__5. Sean proposes, under "Mapping and enriching RDF data":
...
__6. Sean proposes, under "Finding RDF Data" => "...discover datasets":
  * Downloads whole datasets provided as one big file (i.e., a "data dump")__

----------------------------------------------------------------------

__7. Sean proposes, under "Programming RDF Data":
...
__9. Sean proposes, under "Storing RDF data":
...
__ACTION March 11__: Tom to ask John Kunze to propose a competency 
related to management of ARKs.

__ACTION March 11__: Kai to write provenance competency about differentiating simple
